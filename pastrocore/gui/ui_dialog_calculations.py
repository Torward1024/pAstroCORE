...
################################################################################
## Form generated from reading UI file 'dialog_calculationsAECNPc.ui'
##
...
class Ui_CalculationDialog(object):
    def setupUi(self, CalculationDialog):
        ...
        CalculationDialog.resize(671, 628)
...
"}")
        ...
        self.gridLayout_2.addWidget(self.freqList, 3, 0, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.limitFreqsCheck, 2, 0, 1, 2)
...
"}")
        ...
        self.gridLayout_3.addWidget(self.ignoreDepsCheck, 3, 0, 1, 1)
