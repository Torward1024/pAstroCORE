...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon4 = QIcon()
        icon4.addFile(u":/icons/exit_icon.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionExit.setIcon(icon4)
        self.actionExit.setMenuRole(QAction.MenuRole.QuitRole)
        self.actionPreferences = QAction(MainWindow)
        self.actionPreferences.setObjectName(u"actionPreferences")
        icon5 = QIcon()
        icon5.addFile(u":/icons/preferences.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionPreferences.setIcon(icon5)
        self.actionAbout = QAction(MainWindow)
        self.actionAbout.setObjectName(u"actionAbout")
        icon6 = QIcon()
        icon6.addFile(u":/icons/about_icon.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/icons/catalog.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/icons/save_project_as_icon.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/icons/import_icon.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/icons/export_icon.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.actionExport_Calulcated_Data.setIcon(icon10)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionSession.setToolTip(QCoreApplication.translate("MainWindow", u"What has been asked of this project in this session, and replaying a saved one", None))
#endif // QT_CONFIG(tooltip)
        self.actionLast_Run_Report.setText(QCoreApplication.translate("MainWindow", u"Last Run Report", None))
#if QT_CONFIG(tooltip)
        self.actionLast_Run_Report.setToolTip(QCoreApplication.translate("MainWindow", u"What the last calculation run did, step by step", None))
#endif // QT_CONFIG(tooltip)
