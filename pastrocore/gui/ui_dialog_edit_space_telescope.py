...
class Ui_SpaceTelescopeEditorDialog(object):
    ...
    def retranslateUi(self, SpaceTelescopeEditorDialog):
        ...
        self.labelSefdTable.setText(QCoreApplication.translate("SpaceTelescopeEditorDialog", u"SEFD Table (from-to MHz, Jy):", None))
        ...
        self.labelSurfaceEfficiencyTable.setText(QCoreApplication.translate("SpaceTelescopeEditorDialog", u"Surface Efficiency Table (from-to MHz, efficiency):", None))
