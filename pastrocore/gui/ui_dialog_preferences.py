...
################################################################################
## Form generated from reading UI file 'dialog_preferencesZRRFFa.ui'
##
...
class Ui_PreferencesDialog(object):
    def setupUi(self, PreferencesDialog):
        ...
        PreferencesDialog.resize(600, 152)
...
"}")
        ...
        self.gridLayout.addWidget(self.cancelButton, 4, 7, 1, 1)
...
"}")
        ...
        self.gridLayout.addWidget(self.openTelescopesCatalogButton, 1, 7, 1, 1)
...
"}")
        ...
        self.gridLayout.addWidget(self.okButton, 4, 6, 1, 1)
...
"}")
        ...
        self.gridLayout.addWidget(self.openSourcesCatalogButton, 0, 7, 1, 1)
