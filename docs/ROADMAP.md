...
earlier one. **Stages 1 and 2 shipped, in 1.10.0 and 1.11.0; O1 in 1.12.0; C1 and S1 in 1.13.0; L4 in 1.14.0; E1 in 1.15.0; U1 in 1.16.0.**
With E1 the last of stage 3 is in, and U1 is the first of stage 4. What is left, in order: one
more audit, fewer words, the manual -- and then the downloads that need no Python, which are
made of what is finished rather than of what is still being changed.
